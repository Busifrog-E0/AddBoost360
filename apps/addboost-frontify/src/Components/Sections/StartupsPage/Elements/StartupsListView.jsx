...
const StartupsListView = ({ isSlideIndicatorsEnabled = false, title, startups = [], showAllStartupsButton = false }) => {
    ...
    <div className="select-none">
      ...
      {showAllStartupsButton && (
        <div className="flex items-end justify-center mt-8">
          <Button onClick={() => { navigate("/startups-and-sourcing/view-startups") }} text="View Full Companies" />
        </div>
      )}
    </div>
  );
